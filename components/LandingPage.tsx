      ...
      >
        <div className="flex items-center gap-3 group cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          <div className="relative w-10 h-10">
             <div className="absolute inset-0 bg-[#ea580c] rounded-lg rotate-6 opacity-100 group-hover:rotate-12 transition-transform duration-500 shadow-lg"></div>
             <div className="absolute inset-0 bg-stone-950 rounded-lg flex items-center justify-center text-white font-serif text-xl font-bold border border-stone-800">M</div>
          </div>
            ...
            >
              ...
              <div className="book-page-item page-p1 flex flex-col justify-center text-center p-14 bg-[#f9f9f9]">
                 <div className="space-y-8 border-4 border-double border-stone-200 h-full flex flex-col justify-center p-4">
                    <div className="w-10 h-10 mx-auto text-[#ea580c] mb-2">
              ...
              <div className="book-cover flex flex-col items-center justify-center p-14 text-center bg-[#0c0a09] relative overflow-hidden shadow-2xl border-l-4 border-stone-800">
                ...
                <div className="relative z-10 w-full h-full border border-white/10 flex flex-col items-center justify-center">
                    <div className="w-20 h-20 mb-8 flex items-center justify-center text-[#ea580c]">
                    <svg viewBox="0 0 100 100" fill="currentColor" className="w-full h-full drop-shadow-[0_0_15px_rgba(234,88,12,0.6)]">
      ...
      <footer className="py-24 bg-white border-t border-stone-200">
        <div className="max-w-7xl mx-auto px-10 flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 flex items-center justify-center bg-stone-950 rounded-xl text-white font-serif text-xl">M</div>
            <div>
